// Solution 1: solved using promise/then and async/await
...
HTML_coll_loaded.then(loadDOMsubTree)
    .then(getUrls)
...
// Solution 2: solved using nested (successive / climb up) callbacks
